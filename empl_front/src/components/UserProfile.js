...
const URL = "http://localhost:8080/api/role/admin/";
    ...
    this.state = {
     ...
     componentDidMount(){
        ...
        .then(response => {
         ...
         axios.get(URL + "img/" + emp, { headers: authHeader() })
        .then(response => {
            this.setState ({
                img: response.data
            });
    ...
    <div className="row">
        <div className="col-md-4">
           <img alt="" style={{width:"600px",  borderRadius: "50%"}} title="" className="img-circle img-thumbnail isTooltip" src= {this.state.img ? this.state.img : 
			"https://bootdey.com/img/Content/avatar/avatar7.png"} data-original-title="Employee"/>
        </div>
